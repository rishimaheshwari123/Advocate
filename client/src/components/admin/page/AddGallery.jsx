        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="space-y-2 mt-4">
            ...
            >
              ...
              <option value="S.D Taxation Associate">
                S.D Taxation Associate
              </option>
              <option value="S.D Taxation Consultancy">
                S.D Taxation Consultancy
              </option>
              <option value="S.D Taxation Solutions">
                S.D Taxation Solutions
              </option>
              <option value="S.D Accounting Services">
                S.D Accounting Services
              </option>
              <option value="S.D GST & Compliance">S.D GST & Compliance</option>
            </select>
          </div>
